...
export const Sanjeev = {
    ...
    background: "Raghav is a seasoned local politician known for his pragmatic approach to governance. He holds a prominent position in the state legislature. He focuses on issues such as urban development, and industrial mining. He shares a long, intense history with the Mittal family, and there constant ventures for bending laws in their favor.",
    ...
    connectionToMain:"Raghav and Meghna have a working relationship. Meghna has supported some of Raghav’s initiatives that benefit local businesses, and in return, Raghav has helped smooth over any regulatory hurdles for Vista Retreats’ expansion plans. Their interactions are cordial, though not particularly personal.",
    tasks: []
}
...
export const Muskaan = {
    ...
    connectionToMain:"Zoya has a complicated history with Rajesh. They once discussed collaborating on a diamond-inspired resort concept, but the idea fell apart due to Rajesh’s insistence on ethical sourcing. Zoya now views him as an obstacle but recognizes his potential as a tool for her larger schemes.",
    tasks: []
}
...
export const Ashlita = {
    ...
    connectionToMain:"Devina sees Rajesh as a potential ally—or pawn—in her plans. She wants to partner with Vista Retreats to create luxury jewelry boutiques within his resorts, using them as a front for her illicit diamond operations. Devina is patient, willing to cultivate trust before springing her trap.",
    tasks: []
}
...
export const Nehal = {
    ...
    background: "Samira \"Sam\" Kapoor is a dedicated and brilliant medical student in her final year of study at a renowned university. She is visiting her great-uncle Rajesh for the weekend to celebrate his success and reconnect with family. Known for her intelligence, sharp intuition, and calm under pressure, Samira’s medical training allows her to make valuable observations about the crime scene.",
    ...
    connectionToMain:"Rajesh was a mentor and father figure to Samira, and she always admired his success and business acumen. She views him as an inspiration, and his tragic death devastates her. Samira had been looking forward to this trip, both for the celebration and to spend time with Rajesh, whom she trusted deeply.",
    tasks: []
}
...
export const Ashu = {
    ...
    background: "Harshit Whitman is a well-established real estate tycoon with a portfolio of luxury properties across the globe. He has built his empire by acquiring and developing prime real estate in major metropolitan cities and exotic destinations. Known for his keen eye for investment opportunities, Harshit has made a name for himself as a shrewd and calculating businessman.",
    ...
    connectionToMain:"Harshit and Rajesh have crossed paths multiple times in the real estate world. Rajesh has often sought Harshit’s advice on high-end property acquisitions for his resorts, and Harshit has been known to provide insider knowledge on prime locations. Though their relationship is largely professional, some sources suggest that Harshit has always admired Rajesh’s success and wished to integrate more luxury real estate into Rajesh’s resort empire. However, there’s also an undercurrent of competition between them.",
    tasks: []
}
...
export const Tanish = {
    ...
    connectionToMain:"KJ and Rajesh share mutual respect as successful businessmen. KJ has attended Vista Retreats to host exclusive Lakers events, and he has even pitched ideas about creating sports-focused experiences at Rajesh’s resorts. However, their relationship has a competitive edge, as KJ’s high energy often clashes with Rajesh’s traditional approach.",
    tasks: []
}
...
export const Lalitha = {
    ...
    connectionToMain:"Aditi and Rajesh share a strong professional relationship and are well-acquainted through business dealings. Aditi has been looking to expand her cruise line offerings and was considering a partnership with Rajesh’s resorts to create exclusive cruise-and-resort packages. While their business relationship has always been cordial, there’s a hint of rivalry between their two industries.",
    tasks: []
}
...
export const Saloni = {
    ...
    connectionToMain:"Devika and Rajesh share a strong professional relationship and are well-acquainted through business dealings. Devika has been looking to expand her cruise line offerings and was considering a partnership with Rajesh’s resorts to create exclusive cruise-and-resort packages. While their business relationship has always been cordial, there’s a hint of rivalry between their two industries.",
    tasks: []
}
...
export const Reena = {
    ...
    connectionToMain:"Rajesh has been a long-time customer of Isha’s, purchasing rare pieces for his family and his resorts. They have worked together on several high-profile events, and Isha has even designed exclusive jewelry for some of Rajesh’s resorts. Some speculate that their relationship might have extended beyond business, but Isha is careful to maintain an air of mystery about her personal life.",
    tasks: []
}
...
export const Shiven = {
    ...
    background: "Arjun Patel is an undercover detective working for a specialized task force investigating organized crime, corruption, and high-profile business dealings. He was secretly invited to the party by Rajesh, who suspects that his associates and family members may be involved in criminal activities, including the recent murder. Arjun has been given the task of discreetly gathering evidence while keeping his true identity hidden.",
    ...
    connectionToMain:"Arjun's presence is strategic—he poses as a successful tech entrepreneur, a friend of one of Rajesh’s business partners, making his cover solid and unassailable. He’s there to observe, gather intel, and prevent any further criminal activity from unfolding, including the murder of Rajesh. As the party progresses and tensions rise, Arjun realizes that solving Rajesh’s murder becomes his primary mission.",
    tasks: []
}
...
export const Milan = {
    ...
    connectionToMain:"Rajiv was one of Rajesh’s earliest investors and has helped him scale his business significantly. However, their relationship has become strained over the years. Rajiv believes Rajesh is hesitant to take bigger risks and expand internationally, while Rajesh feels Rajiv’s demands are too aggressive. Their tension has simmered for months, with Rajiv wanting to push Rajesh into new markets, but Rajesh remains firm in his decision to maintain quality over quantity.",
    tasks: []
}
...
export const Madhu = {
    ...
    connectionToMain:"Amara and Rajesh have crossed paths before, though their relationship remains ambiguous. Some suspect Rajesh sought Amara’s help in navigating the complex world of luxury resort construction, while others whisper that she has her sights set on leveraging his resorts for her own shadowy dealings. Publicly, they are polite acquaintances, but privately, they share a tense mutual respect, as both know the other is not to be underestimated.",
    tasks: []
}
...
export const Ishita = {
    ...
    background: "Priya Verma is a world-renowned filmmaker in her late 40s, celebrated for her gritty, thought-provoking films that often expose the darker sides of society. Her latest work, Kingdoms of Dust, sparked controversy as it seemed to draw unsettling parallels to Rajesh Kapoor’s rise to fame and fortune, painting a picture of greed, corruption, and familial betrayal. Priya denies the film was based on Rajesh, but the timing and details were too close to ignore.",
    ...
    connectionToMain:"Priya and Rajesh have a long-standing relationship that goes back decades. In her early career, Priya directed promotional films for Rajesh’s resorts, and they shared a mutual respect for each other’s artistic and business sensibilities. However, as their careers grew, their paths diverged. Priya became increasingly critical of the ethics of ultra-wealthy entrepreneurs, while Rajesh saw her growing cynicism as a betrayal of their friendship. Despite their differences, they maintained a complicated bond, oscillating between camaraderie and conflict.",
    tasks: []
}
...
export const Nirmal = {
    ...
    connectionToMain:"Maya has attended several of Rajesh’s high-profile events and has even worked with him in the past on charity initiatives that benefit underprivileged communities. Their relationship is friendly, but it’s clear that Maya admires Rajesh’s business acumen and the way he has built his empire.",
    tasks: []
}
...
export const Nakul = {
    ...
    characterRole: "Cybersecurity consultant ",
    background: "Aarav Mehra is an extraordinary cybersecurity consultant and tech prodigy, still in his late teens but already recognized as one of the brightest minds in the tech industry. Despite his young age, he has developed complex systems that protect major companies from cyber threats and has even been hired by Rajesh to ensure the security of his business and private ventures. Rajesh holds Aarav in high regard, often treating him as a trusted advisor in matters of technology and security.",
    personality:"Aarav is brilliant, introverted, and fiercely focused on his work. He has an innate talent for understanding technology and security systems, often seeing patterns and vulnerabilities that others miss. While he comes across as reserved and quiet, his mind is constantly working, and he is often more comfortable with machines than with people. Aarav is highly disciplined and takes his work very seriously, which has earned him the respect of Rajesh and other high-profile clients.",
    connectionToMain:"Rajesh first met Aarav at a tech conference where Aarav gave a groundbreaking talk on cybersecurity. Impressed by his knowledge and maturity, Rajesh hired him to oversee the security of his resorts and private business dealings. Over time, Aarav became someone Rajesh trusted not just for his expertise but also as a kind of surrogate younger brother. Rajesh even considered Aarav to be a part of his \"extended family\" and often invited him to exclusive events, like the party.",
    tasks: []
}
...
export const Jyoti = {
    ...
    connectionToMain:"Rajesh has supported Anjali’s wellness retreats, hosting some of her events at his resorts. They have a mutual respect for each other’s success and share a common interest in promoting a luxurious lifestyle that includes health and wellness. However, there have been rumors that Anjali may not entirely agree with Rajesh’s more commercialized approach to the wellness industry, viewing it as exploitative.",
    tasks: []
}
...
export const Basu = {
    ...
    connectionToMain:"Bhavik and Rajesh have a complicated professional relationship. Rajesh has funded some of her literary projects, and in return, Sanya has written several pieces about his business ventures. While their collaboration has been fruitful, their relationship is a mix of admiration and tension. Rajesh has often sought her opinions on public relations matters, but Bhavik has been critical of some of his business decisions, especially concerning his more commercialized resort practices.",
    tasks: []
}
...
export const Devna = {
    ...
    connectionToMain:"Aria has worked with Rajesh on multiple occasions, capturing the grandeur of his resort openings and special events. Rajesh admires her work and often gives her free rein to document his family’s celebrations, trusting her to represent them in the most elegant and authentic light.",
    tasks: []
}
...
export const Nidhi = {
    ...
    connectionToMain:"Rajesh has been a patron of Manisha’s art galleries, frequently commissioning pieces for his resorts and event spaces. He has even been involved in financing some of her exhibits. Their relationship is one of mutual respect, though some people suspect there might be more to their connection than meets the eye. Manisha has always admired Rajesh’s business acumen, but she has occasionally disagreed with some of his more conservative decisions, especially when it comes to investing in new forms of art.",
    tasks: []
}
...
export const Deepali = {
    ...
    connectionToMain:"Rajesh is one of Rhea’s loyal clients, commissioning her to design exclusive pieces for various events and promotions at his resorts. Their relationship has been mostly professional, with Rajesh admiring Rhea’s talent and giving her creative freedom to craft unique experiences at his events. However, rumors have circulated about Rhea’s increasing desire for recognition, and she may have some unspoken resentment towards Rajesh for overshadowing her work.",
    tasks: []
}
...
export const Ajit = {
    ...
    connectionToMain:"Ravi was hired by Rajesh to act as a “deterrent” against any potential threats at the event. However, Ravi secretly has deals with some of the diamond mine owners and is not above turning a blind eye to their schemes.",
    tasks: []
}
...
export const Advait = {
    ...
    connectionToMain:"Rohan has a personal connection to Rajesh’s resorts, often visiting them as a retreat from his busy schedule. He has a genuine appreciation for the authenticity and luxury of Vista Retreats. While he’s not as focused on business as KJ, he respects Rajesh’s commitment to quality.",
    tasks: []
}
...
export const Uma = {
    ...
    background: "Meera has an eye for detail and a passion for experiences that blend authenticity and luxury—values that align perfectly with the Mehra resorts. Over the years, she and Rajesh built a strong professional rapport, often discussing ways to enhance Indo-American tourism opportunities. Meera’s presence at the party reflects her support for Indian entrepreneurs thriving abroad, and she views Rajesh as a shining example of success.",
    personality:"Meera Sethi is a charismatic and influential figure in the Indian government, serving as the Minister of Tourism. Known for her innovative campaigns promoting India's cultural and natural beauty, she has been instrumental in boosting tourism to record-breaking levels. She was invited to the party as a gesture of appreciation for her partnership with Rajesh Mehra, who credits part of his resort chain’s success to her efforts in showcasing India as a global destination.",
    connectionToMain:"Though she has no direct involvement in the murder mystery, Meera is quietly lobbying Rajesh to open a resort in India to bring his signature all-inclusive luxury experience to her country. However, she has been frustrated by Rajesh’s hesitance to expand internationally. Her admiration for his success is tinged with disappointment over his reluctance to embrace new horizons.",
    tasks: []
}
...
export const Neha = {
    ...
    connectionToMain:"Rajni and Rajesh have a long-standing professional relationship, with Rajni frequently providing media coverage for Rajesh’s resorts and business ventures. Their partnership is mutually beneficial, though some speculate that Rajni may have bigger ambitions of his own, hoping to eventually control some of Rajesh’s empire.",
    tasks: []
}
